...
class NNProblem(ContinuationProblem):
    ...
    def __init__(self,
        ...
        self.grad_from_batches = grad_from_batches
...
class TsQuantileProblem(TFProblem):
    ...
    def __init__(self,
        ...
        super().__init__(y_train=y_train,
                         ...
                         x_tol_for_hash=x_tol_for_hash,
                         grad_from_batches=grad_from_batches,
                         constraints_limits=constraints_limits)
...
class GradientTestsProblem(TsQuantileProblem):
    ...
    def grad_model(self, individual):
        ...
        if self.grad_from_batches:
            self.moo_model_input_train_batched = batch_array(self.moo_model_input_train, self.grad_batch_size)
            self.y_train_batches = batch_array(self.y_train, self.grad_batch_size)
            batched_grads = []
